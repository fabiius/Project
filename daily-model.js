...
function validateEntry(value,base,entries,editingId){
 ...
 const days=new Map();for(const e of [...previous,value])days.set(e.record_date,(days.get(e.record_date)||0)+num(e.base_added)-contacted(e));
...
const api={fields,entryFields,sumBase,num,contacted,today,dateLabel,validDate,stats,report,validateEntry};root.DailyModel=api;if(typeof module!=='undefined')module.exports=api;
